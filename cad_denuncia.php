  ...
  <div class="card">
    ...
    <form action="db/mail/email.php" method="post" Style="margin-top: 50px;" enctype="multipart/form-data">
      <div class="form-group col-md-6 offset-md-3">
        ...
        <input type="titulo" class="form-control" id="titulon" aria-describedby="text" placeholder="Titulo da Denúncia" name="titulo">
      ...
      <div class="was-validated">
        <div class="col-md-6 offset-md-3">
          ...
          <textarea class="form-control is-invalid" id="validationTextarea" name="descricao" placeholder="Precisa descrever" required></textarea>
      ...
      <div class="form-group col-md-6 offset-md-3">
        ...
        <input type="texto" class="form-control" id="endrua" placeholder="Rua" name="rua">
      </div>
      <div class="form-group col-md-6 offset-md-3">
        <label for="exampleInput">Bairro</label>
        <input type="texto" class="form-control" id="endbairro" placeholder="Bairro" name="bairro">
      </div>
      <div class="form-group col-md-6 offset-md-3">
        <label for="exampleInput">Cidade</label>
        <input type="texto" class="form-control" id="endbairro" placeholder="Cidade" name="cidade">
      </div>
      <div class="was-validated">
