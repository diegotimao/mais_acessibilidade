...
<div class="container" style="margin-top:30px;">
  <div class="text-small  text-muted">
    <h2><strong> Todas as Denucias</strong>&nbsp;&nbsp;<img src="img/incones/noticia.png" class="img-fluid" style="width:45px; height:45px; "></h2>
  </div>
</div>
<section class="container-fluid" style="margin-top: 50px;">
  <div class="bg-white box-shadow py-5 px-4 px-sm-5">
    <div class="row">
      <?php
      include 'db/exibir_todas_denuncias.php';
      foreach ($info as $key => $value) { ?>
        <div class="col-md-6 pb-4 mb-3">
          ...
          <h6><a href="denuncia1.php?id=<?php echo $value['id']; ?>" class="card-title text-justify" style="margin-right: 8px; margin-left: 8px; cursor: pointer;"><?php echo mb_strimwidth($value['titulo'], 0, 65, '...'); ?></a></h6>
          <p class="card-text text-justify" style="margin-right: 6px; margin-left: 6px; cursor: pointer;"> <?php echo mb_strimwidth($value['descricao'], 0, 200, '...');  ?></p>
